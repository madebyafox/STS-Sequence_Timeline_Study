<?php 
session_start(); 
$_SESSION["page"] = "trafficRL.php";
include('includes/draggyHeader.php'); 
?>
<div class="top">
	<form method="post" id="next_page" action="main.php">
	<button type = "submit" class="timelineSubmit">Submit</button>
	</form>
	<audio autoplay >
...
var timeline = svg.append("path")
		.attr("d","M660.5,289.5v12h-486v-12H660.5z M160.5,295.685l14.508,10.163l-0.17-20.695 L160.5,295.685z")
		.attr("fill","black")
		.attr("transform","scale(2 1.5) translate(-158, -60)")
		.attr("stroke","black")
