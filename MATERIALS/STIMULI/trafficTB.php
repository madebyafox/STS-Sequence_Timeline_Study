...
var timeline = svg.append("path")
		.attr("d","M416.5,531.5h-12v-486h12V531.5z M420.848,531.434l-20.695-0.17l10.163,14.508 L420.848,531.434z")
		.attr("fill","black")
		.attr("transform","scale(1.5 2) translate(-150, -200)")
		.attr("stroke","black")
